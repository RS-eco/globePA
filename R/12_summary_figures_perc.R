...
p1 <- ter_dat %>% filter(path=="Annual mean temp. (°C)") %>% ggplot() + 
  ...
  geom_text(data=test %>% filter(path=="Annual mean temp. (°C)"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Annual mean temp. (°C)"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Annual mean temp. (°C)"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p2 <- ter_dat %>% filter(path=="Annual precipitation (mm)") %>% ggplot() + 
  ...
  geom_text(data=test %>% filter(path=="Annual precipitation (mm)"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Annual precipitation (mm)"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Annual precipitation (mm)"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  scale_x_continuous(breaks=c(2,26,50,75,99), 
...
p3 <- ter_dat %>% filter(path=="Elevation (m)") %>% ggplot() + 
  ...
  geom_text(data=test %>% filter(path=="Elevation (m)"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Elevation (m)"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Elevation (m)"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  scale_x_continuous(breaks=c(2,26,50,75,99), 
...
p4 <- marspec_dat %>% filter(path=="Mean annual SST (°C)") %>%
  ...
  geom_text(data=test %>% filter(path=="Mean annual SST (°C)"), aes(x = 48, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Mean annual SST (°C)"), aes(x = 48, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Mean annual SST (°C)"), aes(x = 48, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p5 <- marspec_dat %>% filter(path=="Mean annual SSS (psu)") %>%
  ...
  geom_text(data=test %>% filter(path=="Mean annual SSS (psu)"), aes(x = 42, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Mean annual SSS (psu)"), aes(x = 42, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Mean annual SSS (psu)"), aes(x = 42, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p6 <- marspec_dat %>% filter(path=="Bathymetry (m)") %>% 
  ...
  geom_text(data=test %>% filter(path=="Bathymetry (m)"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Bathymetry (m)"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Bathymetry (m)"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  scale_x_continuous(breaks=c(2,26,50,75,99), 
