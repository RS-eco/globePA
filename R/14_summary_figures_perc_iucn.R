...
p1 <- ter_dat %>% filter(path=="Annual mean temp. (°C)") %>% ggplot() + 
  ...
  geom_text(data=test, aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test, aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test, aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p1 <-  marspec_dat %>% filter(path=="Mean annual SST (°C)") %>%
  ...
  geom_line(aes(x=var, y=exp), colour="black") + 
  geom_text(data=test, aes(x = 48, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test, aes(x = 48, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test, aes(x = 48, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  facet_grid(iucn_cat ~ path, switch="x", scales="free_y") + 
...
p2 <- marspec_dat %>% filter(path=="Annual range in SST") %>%
  ggplot() + geom_bar(aes(x = var, y=perc, fill=iucn_cat), width=1, stat="identity", position="stack") +
  geom_line(aes(x=var, y=exp), colour="black") + 
  geom_text(data=test, aes(x = 49, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test, aes(x = 49, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test, aes(x = 49, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  facet_grid(iucn_cat ~ path, switch="x", scales="free_y") + 
...
p4 <- marspec_dat %>% filter(path=="Mean annual SSS (psu)") %>%
  ggplot() + geom_bar(aes(x = var, y=perc, fill=iucn_cat), width=1, stat="identity", position="stack") +
  geom_line(aes(x=var, y=exp), colour="black") + 
  geom_text(data=test, aes(x = 42, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test, aes(x = 42, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test, aes(x = 42, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  facet_grid(iucn_cat ~ path, switch="x", scales="free_y") + 
...
p5 <- marspec_dat %>% filter(path=="Annual range in SSS") %>%
  ggplot() + geom_bar(aes(x = var, y=perc, fill=iucn_cat), width=1, stat="identity", position="stack") +
  geom_line(aes(x=var, y=exp), colour="black") + 
  geom_text(data=test, aes(x = 35, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test, aes(x = 35, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test, aes(x = 35, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  facet_grid(iucn_cat ~ path, switch="x", scales="free_y") + 
...
p6 <- marspec_dat %>% filter(path=="Annual variance in SSS") %>%
  ggplot() + geom_bar(aes(x = var, y=perc, fill=iucn_cat), width=1, stat="identity", position="stack") +
  geom_line(aes(x=var, y=exp), colour="black") + 
  geom_text(data=test, aes(x = 41, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test, aes(x = 41, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test, aes(x = 41, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  facet_grid(iucn_cat ~ path, switch="x", scales="free_y") + 
