...
p1 <- ter_dat %>% filter(path=="Temperature seasonality") %>% ggplot() + 
  ...
  geom_text(data=test %>% filter(path=="Temperature seasonality"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Temperature seasonality"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Temperature seasonality"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p2 <- ter_dat %>% filter(path=="Temperature annual range") %>% ggplot() + 
  ...
  geom_text(data=test %>% filter(path=="Temperature annual range"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Temperature annual range"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Temperature annual range"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  scale_x_continuous(breaks=c(2,26,50,75,99), 
...
p3 <- ter_dat %>% filter(path=="Precipitation seasonality") %>% ggplot() + 
  ...
  geom_text(data=test %>% filter(path=="Precipitation seasonality"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Precipitation seasonality"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Precipitation seasonality"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
  scale_x_continuous(breaks=c(2,26,50,75,99), 
...
p1 <- marspec_dat %>% filter(path=="Annual range in SST") %>%
  ...
  geom_text(data=test %>% filter(path=="Annual range in SST"), aes(x = 49, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Annual range in SST"), aes(x = 49, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Annual range in SST"), aes(x = 49, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p2 <- marspec_dat %>% filter(path=="Annual variance in SST") %>%
  ...
  geom_text(data=test %>% filter(path=="Annual variance in SST"), aes(x = 50, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Annual variance in SST"), aes(x = 50, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Annual variance in SST"), aes(x = 50, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p3 <- marspec_dat %>% filter(path=="Annual range in SSS") %>%
  ...
  geom_text(data=test %>% filter(path=="Annual range in SSS"), aes(x = 35, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Annual range in SSS"), aes(x = 35, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Annual range in SSS"), aes(x = 35, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
...
p4 <- marspec_dat %>% filter(path=="Annual variance in SSS") %>%
  ...
  geom_text(data=test %>% filter(path=="Annual variance in SSS"), aes(x = 41, y = Inf,  label=paste("chi^2 ==", chisq)), vjust = +1.5, parse=T) + 
  geom_text(data=test %>% filter(path=="Annual variance in SSS"), aes(x = 41, y = Inf,  label=paste("df = ", df)), vjust = +4) + 
  geom_text(data=test %>% filter(path=="Annual variance in SSS"), aes(x = 41, y = Inf,  label=paste("p = ", pvalue)), vjust = +5.75) + 
